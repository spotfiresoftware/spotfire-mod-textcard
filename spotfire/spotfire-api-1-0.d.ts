 ...
 * @public
 */
export declare interface AnalysisProperty<
 ...
 * @public
 */
export declare type AnalysisPropertyDataType =
  | string
  | number
  | boolean
  | Date
 ...
 * @public
 */
export declare interface AnalysisPropertyValue<
  T extends AnalysisPropertyDataType = AnalysisPropertyDataType
> {
  /**
 ...
 * @public
 */
export declare interface DataViewContinuousValue<
 ...
 * @public
 */
export declare type DataViewValueType =
  | number
  | string
  | boolean
  | Date
 ...
 * @public
 */
export declare type ExtractValueType<
  readableArray extends ReadonlyArray<Readable<any>>
> = {
  [readableName in keyof readableArray]: readableArray[readableName] extends Readable<
    infer readableNameType
  >
    ? readableNameType
    : never;
};
 ...
 * @public
 */
export declare type MarkingOperation =
  | "Replace"
  | "Add"
  | "Subtract"
  | "Toggle"
...
export declare interface Mod {
   ...
   */
  createReader<T extends ReadonlyArray<Readable>>(
    ...readables: T
 ...
 * @public
 */
export declare interface ModProperty<
  T extends ModPropertyDataType = ModPropertyDataType
> extends ModPropertyValue<T> {
  /**
   * Set the value of this instance.
   * @param value - The value to set.
   */
 ...
 * @public
 */
export declare interface ModPropertyValue<
  T extends ModPropertyDataType = ModPropertyDataType
> {
  /**
   * Gets the name of this instance.
